...
use App\Repository\TbleEmployeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=TbleEmployeRepository::class)
 */
class TbleEmploye
{
    /**
     ...
     * @ORM\OneToMany(targetEntity=TbleProduit::class, mappedBy="introduit_par")
     * @ORM\OneToMany(targetEntity=TbleAffaire::class, mappedBy="traiter_par")
     * @ORM\OneToMany(targetEntity=TbleCommandeClt::class, mappedBy="commande_par")
     * @ORM\OneToMany(targetEntity=TbleProspectClient::class, mappedBy="pris_en_charge_par")
     * @ORM\OneToMany(targetEntity=TbleFacture::class, mappedBy="traiter_par_facture")
     * @ORM\OneToMany(targetEntity=TbleOrdreAchat::class, mappedBy="aprouve_par")
     * @ORM\OneToMany(targetEntity=TbleLivrableAttendu::class, mappedBy="proprietaire_liv")
     * @ORM\OneToMany(targetEntity=TbleFournisseur::class, mappedBy="pris_en_charge_par_fournisseur")
     * @ORM\OneToMany(targetEntity=TblePaiement::class, mappedBy="proprietaire_pnt")
     * @ORM\OneToMany(targetEntity=TbleDepenses::class, mappedBy="introduite_par")
     * @ORM\OneToMany(targetEntity=TbleDevis::class, mappedBy="traiter_par")
     * @ORM\OneToMany(targetEntity=TbleConge::class, mappedBy="id_employe_conge")
     * @ORM\OneToMany(targetEntity=TbleAlarmesRappelReminders::class, mappedBy="employer_a_rappeler")
     * @ORM\OneToMany(targetEntity=TblePaiementFRS::class, mappedBy="employer_a_rappeler")
     */
