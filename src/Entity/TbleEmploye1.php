...
use App\Repository\TbleEmploye1Repository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=TbleEmploye1Repository::class)
 */
class TbleEmploye1
{
    /**
     ...
     * @ORM\OneToMany(targetEntity=TbleCommandeClt::class, mappedBy="traiter_par_cde")
     * @ORM\OneToMany(targetEntity=TbleOrdreAchat::class, mappedBy="cree_par")
     */
    private $id;
